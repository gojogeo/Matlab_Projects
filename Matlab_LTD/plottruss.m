function plottruss(truss, condition,  colordraw)
    subplot(2,1,1);
    hold on
    ...
    grid on
    h1=plot(0,'Color',colordraw,'DisplayName',condition);
    %h2=plot(0,'-r','DisplayName','external force');
    %h3=plot(0,'-^b','DisplayName','reaction force');
